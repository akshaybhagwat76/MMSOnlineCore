...
namespace MMS.data.Repository
{
	...
	{
		public TransactionOtherPicturesRepository(IConnectionFactory connectionFactory) : base(connectionFactory) { }
		...
		public async Task<TransactionOtherPictures> Get(System.Int64? id)
		{
			...
			{
				var query = "[dbo].TransactionOtherPictures_SELECT";
		...
		public async Task<IEnumerable<TransactionOtherPictures>> Search(int pageIndex, int pageSize)
		{
			...
			using (var connection = connectionFactory.GetConnection)
			{
				var query = "[dbo].TransactionOtherPictures_PAGING";
				var param = new DynamicParameters();
		...
		public async Task<IEnumerable<TransactionOtherPictures>> Search(int pageIndex, int pageSize,string sortBy, string orderBy)
		{
			...
			using (var connection = connectionFactory.GetConnection)
			{
				var query = "[dbo].TransactionOtherPictures_SORT";
				var param = new DynamicParameters();
				param.Add("@PageIndex", pageIndex);
				param.Add("@PageSize", pageSize);
		...
		public async Task<IEnumerable<TransactionOtherPictures>> Search(int pageIndex, int pageSize,string sortBy, string orderBy, string searchstring)
		{
			
			using (var connection = connectionFactory.GetConnection)
			{
				var query = "[dbo].TransactionOtherPictures_CUSTOM";
				var param = new DynamicParameters();
				param.Add("@PageIndex", pageIndex);
				param.Add("@PageSize", pageSize);
				param.Add("@sortBy", sortBy);
		...
		public async Task<IEnumerable<TransactionOtherPictures>> Search(System.Int64? id, System.String accountID, System.String ticketNumber, System.String pictureID, System.String thumbnailURL, System.String fullResURL)
		{
			try
			{
				...
				using (var connection = connectionFactory.GetConnection)
				{
					var query = "[dbo].TransactionOtherPictures_SEARCH";
					var param = new DynamicParameters();
					param.Add("id",id, DbType.Int64);
		...
		#region INSERT
		/// <summary>
		/// Insert current TransactionOtherPictures to database.
		/// </summary>
		...
		public async Task<System.Int64> Insert(System.String accountID, System.String ticketNumber, System.String pictureID, System.String thumbnailURL, System.String fullResURL)
		{
			try
			{
				...
				using (var connection = connectionFactory.GetConnection)
				{
					var query = "[dbo].TransactionOtherPictures_INSERT";
					var param = new DynamicParameters();
					param.Add("accountID", accountID, DbType.String);
					param.Add("ticketNumber", ticketNumber, DbType.String);
					param.Add("pictureID", pictureID, DbType.String);
		...
		/// Insert current TransactionOtherPictures to database.
		/// </summary>
		/// <param name=TransactionOtherPictures Objects>TransactionOtherPictures</param>
		public async Task<System.Int64> Insert(TransactionOtherPictures model)
		{
			try
			{
		...
		#region UPDATE
		/// <summary>
		/// Update current TransactionOtherPictures to database.
		/// </summary>
		/// <param name="id">System.Int64?</param>
		/// <param name="accountID">System.String</param>
		/// <param name="ticketNumber">System.String</param>
		...
		public async Task<int> Update(System.Int64? id, System.String accountID, System.String ticketNumber, System.String pictureID, System.String thumbnailURL, System.String fullResURL)
		{
			try
			{
				...
				using (var connection = connectionFactory.GetConnection)
				{
					var query = "[dbo].TransactionOtherPictures_UPDATE";
					var param = new DynamicParameters();
					param.Add("id", id, DbType.Int64);
					param.Add("accountID", accountID, DbType.String);
					param.Add("ticketNumber", ticketNumber, DbType.String);
		...
		public async Task<int> Update(TransactionOtherPictures model)
		{
			try
			{
		...
		#region DELETE
		/// <summary>
		/// Delete current TransactionOtherPictures from database.
		/// </summary>
		/// <param name="id">System.Int64?</param>
		public async Task<int> Delete(System.Int64? id)
		{
			using (var connection = connectionFactory.GetConnection)
			{
				var query = "[dbo].TransactionOtherPictures_DELETE";
				var param = new DynamicParameters();
				param.Add("id", id, DbType.Int64);
