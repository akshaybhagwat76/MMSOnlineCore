...
namespace MMS.data.Repository
{
	...
	{
		public TransactionScalePicturesRepository(IConnectionFactory connectionFactory) : base(connectionFactory) { }
		...
		public async Task<TransactionScalePictures> Get(System.Int64? id)
		{
			...
			{
				var query = "[dbo].TransactionScalePictures_SELECT";
		...
		public async Task<IEnumerable<TransactionScalePictures>> Search(int pageIndex, int pageSize)
		{
			...
			using (var connection = connectionFactory.GetConnection)
			{
				var query = "[dbo].TransactionScalePictures_PAGING";
				var param = new DynamicParameters();
		...
		public async Task<IEnumerable<TransactionScalePictures>> Search(int pageIndex, int pageSize,string sortBy, string orderBy)
		{
			...
			using (var connection = connectionFactory.GetConnection)
			{
				var query = "[dbo].TransactionScalePictures_SORT";
				var param = new DynamicParameters();
				param.Add("@PageIndex", pageIndex);
				param.Add("@PageSize", pageSize);
		...
		public async Task<IEnumerable<TransactionScalePictures>> Search(int pageIndex, int pageSize,string sortBy, string orderBy, string searchstring)
		{
			
			using (var connection = connectionFactory.GetConnection)
			{
				var query = "[dbo].TransactionScalePictures_CUSTOM";
				var param = new DynamicParameters();
				param.Add("@PageIndex", pageIndex);
				param.Add("@PageSize", pageSize);
				param.Add("@sortBy", sortBy);
		...
		public async Task<IEnumerable<TransactionScalePictures>> Search(System.Int64? id, System.String accountID, System.String ticketNumber, System.String pictureID, System.String thumbnailURL, System.String fullResURL)
		{
			try
			{
				...
				using (var connection = connectionFactory.GetConnection)
				{
					var query = "[dbo].TransactionScalePictures_SEARCH";
					var param = new DynamicParameters();
					param.Add("id",id, DbType.Int64);
		...
		#region INSERT
		/// <summary>
		/// Insert current TransactionScalePictures to database.
		/// </summary>
		...
		public async Task<System.Int64> Insert(System.String accountID, System.String ticketNumber, System.String pictureID, System.String thumbnailURL, System.String fullResURL)
		{
			try
			{
				...
				using (var connection = connectionFactory.GetConnection)
				{
					var query = "[dbo].TransactionScalePictures_INSERT";
					var param = new DynamicParameters();
					param.Add("accountID", accountID, DbType.String);
					param.Add("ticketNumber", ticketNumber, DbType.String);
					param.Add("pictureID", pictureID, DbType.String);
		...
		/// Insert current TransactionScalePictures to database.
		/// </summary>
		/// <param name=TransactionScalePictures Objects>TransactionScalePictures</param>
		public async Task<System.Int64> Insert(TransactionScalePictures model)
		{
			try
			{
		...
		#region UPDATE
		/// <summary>
		/// Update current TransactionScalePictures to database.
		/// </summary>
		/// <param name="id">System.Int64?</param>
		/// <param name="accountID">System.String</param>
		/// <param name="ticketNumber">System.String</param>
		...
		public async Task<int> Update(System.Int64? id, System.String accountID, System.String ticketNumber, System.String pictureID, System.String thumbnailURL, System.String fullResURL)
		{
			try
			{
				...
				using (var connection = connectionFactory.GetConnection)
				{
					var query = "[dbo].TransactionScalePictures_UPDATE";
					var param = new DynamicParameters();
					param.Add("id", id, DbType.Int64);
					param.Add("accountID", accountID, DbType.String);
					param.Add("ticketNumber", ticketNumber, DbType.String);
		...
		public async Task<int> Update(TransactionScalePictures model)
		{
			try
			{
		...
		#region DELETE
		/// <summary>
		/// Delete current TransactionScalePictures from database.
		/// </summary>
		/// <param name="id">System.Int64?</param>
		public async Task<int> Delete(System.Int64? id)
		{
			using (var connection = connectionFactory.GetConnection)
			{
				var query = "[dbo].TransactionScalePictures_DELETE";
				var param = new DynamicParameters();
				param.Add("id", id, DbType.Int64);
